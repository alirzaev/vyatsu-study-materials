...
int WINAPI WinMain(
	...
	LoadTextFromFile = (std::string(*)(const std::string&)) GetProcAddress(dll, "LoadTextFromFile");
	ansi_tolower = (int(*)(int)) GetProcAddress(dll, "ansi_tolower");
	ansi_toupper = (int(*)(int)) GetProcAddress(dll, "ansi_toupper");
	ShowDifferences = (std::pair<std::string, std::string>(*)(const std::string&, const std::string&)) GetProcAddress(dll, "ShowDifferences");
